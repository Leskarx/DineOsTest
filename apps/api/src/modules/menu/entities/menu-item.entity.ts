import {
  ...
  UpdateDateColumn, Index, ManyToOne, JoinColumn, OneToMany,
} from 'typeorm';
...
export class MenuItem {
  ...
  // ← Relation so getItems/getItem can load GST rate details
  @ManyToOne(() => GstRate, { nullable: true, eager: false })
