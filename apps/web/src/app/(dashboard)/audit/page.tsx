      ...
      <div className="flex flex-wrap items-center gap-2 px-6 py-3 border-b border-slate-800 bg-slate-900/50 flex-shrink-0">
        ...
        <div className="relative">
          ...
          <input
            ...
            className={cn(
              'text-xs bg-slate-800 border text-slate-300 rounded-lg pl-6 pr-2 py-1.5 w-48 focus:outline-none focus:ring-1',
              userFilterError
              ...
              {logs.map((log) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-2.5 text-slate-500 font-mono">{log.ipAddress ?? '—'}</td>
                    <td className="px-4 py-2.5">
                      {hasDiff
