      ...
      {isLoading ? (
        <div className="space-y-6 animate-pulse mt-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
            {[...Array(5)].map((_, i) => <div key={i} className="bg-slate-200 dark:bg-slate-800 rounded-2xl h-24" />)}
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="bg-slate-200 dark:bg-slate-800 rounded-2xl h-80 lg:col-span-2" />
