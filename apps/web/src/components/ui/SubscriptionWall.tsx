      ...
      <div className="relative w-full max-w-md mx-4 card p-8 text-center space-y-6 shadow-2xl border border-amber-800/40">
        ...
        <div className="mx-auto w-16 h-16 rounded-2xl bg-amber-500/10 border border-amber-500/30 flex items-center justify-center">
          {isExpired ? (
            ...
            <CreditCard size={30} className="text-amber-400" />
          )}
        </div>
        ...
        {/* Plan badge */}
        {plan && (
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-800 border border-slate-700 text-xs text-slate-300 mx-auto">
        ...
        <p className="text-xs text-slate-600">
          Questions? Contact{' '}
          <a href="mailto:support@dinestay.app" className="text-slate-500 hover:text-slate-400 underline">
